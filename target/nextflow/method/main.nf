...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/test-nextflow-wave-fusion/test-nextflow-wave-fusion/src/method/config.vsh.yaml"
      },
      {
        "type" : "file",
        "path" : "resource.txt",
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "viash_version" : "0.7.2",
    "git_commit" : "ee70d55267781e531d3273c4d53300dd3c5ec623",
